...
namespace solutions
{
SolutionTwo::SolutionTwo() : m_totalSum(0)
{
	work();
}

std::string SolutionTwo::answer()
{
	return m_answer;
}
/**
